...
def Analyze(x,y,z):
    ...
    print('y:',y)
    print('z:',z)
    print('x, N:',len(x),'mean:',st.mean(x),' +- ',math.sqrt(st.variance(x)/len(x)),'median:',st.median(x),'var:',st.variance(x))
    print('y, N:',len(y),'mean:',st.mean(y),' +- ',math.sqrt(st.variance(y)/len(y)),'median:',st.median(y),'var:',st.variance(y))
    print('z, N:',len(z),'mean:',st.mean(z),' +- ',math.sqrt(st.variance(z)/len(z)),'median:',st.median(z),'var:',st.variance(z))
    zcopy = z.copy()
    zcopy.sort()
